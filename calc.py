...
def evaluate_calculation():
    ...
    try:
        ...
        calculation = result  # Update the calculation with the result for further calculations
    except:
        clear_field()
...
btn_noteq= tk.Button(root,text="!",command=lambda:add_to_calculation("!"),width=5,font=("Arial",14))
btn_noteq.grid(row=5,column=1)
